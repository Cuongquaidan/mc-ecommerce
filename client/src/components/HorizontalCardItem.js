    ...
    return (
        ...
        >
            <motion.div
                ...
                className="w-full relative min-w-[280px] border-neutral-600 dark:border md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-48 bg-white rounded-md shadow-md flex dark:bg-neutral-950 overflow-hidden "
            >
                ...
                <motion.div
                    className="relative z-10 grid p-4 overflow-hidden"
                    initial={{
                        y: 30,
                    }}
                    animate={{
