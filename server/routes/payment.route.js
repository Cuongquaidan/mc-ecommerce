...
// router.route("/create-payment-VNPAYUrl").post(paymentController.createVNPAYUrl);
// router.route("/vnpay_return").get(paymentController.vnpayReturn);
// router.route("/vnpay_ipn").get(paymentController.vnpayIPN);
...
router.post("/create_payment_VNPAYUrl", function (req, res, next) {
